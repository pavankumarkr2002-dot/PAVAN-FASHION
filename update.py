...
html = re.sub(r'      // Nav\s+window\.goTo = \(page\) => \{.*?\};', new_goto, html, flags=re.DOTALL)
...
# 3. Wrap homepage and insert MAN page structure
if '<!-- Hero -->' in html and '<!-- Footer -->' in html:
    parts = html.split('<!-- Hero -->', 1)
    before_hero = parts[0]
    rest = parts[1]
    
    parts_bot = rest.split('<!-- Footer -->', 1)
    home_content = parts_bot[0]
    footer_content = parts_bot[1]
  ...
  <div id="page-man" class="page">
    ...
    <section class="hero">
      ...
      <div class="slide">
        ...
        <div class="slide-content sc-2" style="text-align: right; left: auto; right: 64px;">
          ...
          <div class="ov-hide"><div class="cta-wrap anim-el del-4" style="justify-content: flex-end;"><a href="javascript:void(0)" class="btn btn-ghost">DISCOVER ORIGINS</a></div></div>
        </div>
      </div>
      <div class="slide">
        ...
        <div class="hero-overlay"></div>
        <div class="slide-content sc-3" style="text-align: center; left: 50%; transform: translateX(-50%); width: 100%;">
          ...
          <div class="ov-hide"><div class="cta-wrap anim-el del-4" style="justify-content: center; gap: 12px;"><a href="javascript:void(0)" class="btn btn-white">SHOP THE EDIT</a><a href="javascript:void(0)" class="btn btn-ghost">EXPLORE ALL</a></div></div>
        </div>
      </div>
      <div class="hero-dots">
    ...
    <section>
      <div class="man-ed-1 reveal-item">
        ...
        <div class="man-ed-1-text anim-el">
          ...
          <a href="javascript:void(0)" class="btn btn-white">SHOP ALL</a>
        </div>
      </div>
      ...
      <div class="man-ed-row-3 reveal-item" id="man-parallax-1">
        ...
        <div class="camp-content">
          ...
          <div class="ov-hide"><div class="anim-el del-4"><a href="javascript:void(0)" class="btn btn-ghost" style="border-color:#fff;">DISCOVER MORE &rarr;</a></div></div>
        </div>
      </div>
      <div class="man-ed-row-4 reveal-item">
        ...
        <div class="man-ed-row-4-right">
          ...
          <div class="man-ed-row-4-r-bot">
            ...
            <div class="mer4-desc">Inspired by heritage. Natural materials, timeless silhouettes, made to last.</div>
    ...
    <section class="origins-sec reveal-item">
      ...
      <div class="origins-text anim-el">
        ...
        <a href="javascript:void(0)" class="btn btn-ghost" style="border-color: rgba(255,255,255,0.5);">SHOP ORIGINS</a>
      </div>
    </section>
    ...
    <section class="reveal-item">
      <div class="section-header">
        ...
        <div class="sh-right" style="text-decoration:underline;">VIEW ALL &rarr;</div>
      </div>
